...
impl NetNsGuard {
    pub fn new() -> Self {
        ...
        // let check_config_output = Command::new("/bin/tree").output();
        // match check_config_output {
        //     Ok(output) => {
        //         eprintln!("tree: {}", output.status);
        //         io::stdout().write_all(&output.stdout).unwrap();
        //         io::stderr().write_all(&output.stderr).unwrap();
        //     }
        //     Err(e) => {
        //         eprintln!("Failed to run /bin/tree: {e}");
        //     }
        // }

        // let check_config_output = Command::new("/bin/check-config.sh").output();
        // match check_config_output {
        //     Ok(output) => {
        ...
        //     }
        //     Err(e) => {
        //         eprintln!("Failed to run /bin/check-config.sh: {e}");
        //     }
        // }
